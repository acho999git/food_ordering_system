...
public class RestaurantApprovalResponseKafkaListener implements KafkaConsumer<RestaurantApprovalResponseAvroModel> {
    ...
    //this above class is from  the input ports
    ...
    public RestaurantApprovalResponseKafkaListener(
            final RestaurantApprovalResponseMessageListener restaurantApprovalResponseMessageListener,
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
            if (OrderApprovalStatus.APPROVED == restaurantApprovalResponseAvroModel.getOrderApprovalStatus()) {
                ...
                restaurantApprovalResponseMessageListener.orderApproved(orderMessagingDataMapper
                        .toRestaurantApprovalResponse(restaurantApprovalResponseAvroModel));
