...
@Slf4j
@Component
public class PaymentCanceledMessagePublisherImplAdapter implements PaymentCancelledMessagePublisher {
    ...
    @Autowired
    public PaymentCanceledMessagePublisherImplAdapter(final PaymentMessagingDataMapper paymentMessagingDataMapper,
    ...
    public void publish(final PaymentCancelledEvent domainEvent) {
        ...
        log.info("Received PaymentCancelledEvent event - OrderId: {}", orderId);
        try{
